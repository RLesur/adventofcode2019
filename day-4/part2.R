...
res <-
  ...
  mutate(
    eq_12 = digit_1 == digit_2 & digit_2 != digit_3,
    eq_23 = digit_2 == digit_3 & digit_2 != digit_1 & digit_3 != digit_4,
    eq_34 = digit_3 == digit_4 & digit_3 != digit_2 & digit_4 != digit_5,
    eq_45 = digit_4 == digit_5 & digit_4 != digit_3 & digit_5 != digit_6,
    eq_56 = digit_5 == digit_6 & digit_5 != digit_4,
  ) %>%
  mutate(
